    ...
    <div className="container-fluid">
      <div className="row flex-nowrap">
        <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
          <div className="d-flex flex-column align-items-center aligm-items-sm-start px-3 pt-2 text-white min-vh-100">
            <Link
              to="/dashboard"
            ...
            >
              ...
              <li className="w-100">
                ...
                >
                  ...
                  <span className="ms-2 d-none d-sm-inline">Empresas</span>
                </Link>
              </li>
              <li className="w-100">
                <Link
              ...
              <li className="w-100">
                <Link
                  ...
                  className="nav-link px-0 aling-middle text-white"
                >
                  <i className="fs-4 bi-columns ms-2 ms-2"></i>
